...
<template>
  <Layout>
    ...
    <div class="page-wrapper">
      ...
      <div class="col-12 col-lg-12 mt-4 mb-6 ps-3" style="margin-left: 300px;">
      ...
      <h4 class="mb-2 my-6 ml-2" style="margin-left: 300px;">Gallery</h4>
      <div class="row  row-cols-auto g-3" style="margin-left: 300px;">
        <div class="col" v-if="activation?.images?.length > 0" v-for="image in activation?.images" :key="image.id">
          <div class="card">
