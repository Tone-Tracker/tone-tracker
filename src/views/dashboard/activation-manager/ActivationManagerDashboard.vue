							...
							<div class="card-body">
								<div class="text-center">
									<div class="widgets-icons mx-auto  mb-3">
                                        <i class='bx bxs-envelope' style='color:#0d6efd' ></i>

									</div>
									<p class="mb-0 text-secondary">Total Emails Sent</p>
									<h4 class="my-1 maz-height">840</h4>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="text-center">
									...
									<p class="mb-0 text-secondary">Emails Read</p>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="text-center">
									...
									<p class="mb-0 text-secondary">Emails Unread</p>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="text-center">
									...
									<h4 class="my-1 maz-height">3800</h4>
