                       ...
                       <div>
						...
						<div  class="d-flex w-100"> 
							<div v-if="ndaFile"  class="file-details mt-2 w-100 p-1 border rounded d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <i @click="download('nda')" class='bx bxs-download maz-gradient-txt fs-2 cursor-pointer' v-tooltip="'Download'" ></i>
                       ...
                       <div>
						...
						<div  class="d-flex w-100"> 
							<div v-if="slaFile"  class="file-details mt-2 w-100 p-1 border rounded d-flex align-items-center">
                                ...
                                <div class="ms-auto">
                                    <i @click="download('sla')" class='bx bxs-download maz-gradient-txt fs-2 cursor-pointer' v-tooltip="'Download'" ></i>
