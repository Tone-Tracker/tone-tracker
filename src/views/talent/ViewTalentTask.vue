        ...
        <div class="page-wrapper">
			<div class="page-content">
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
							<button @click="showImagesSheet = true" class="btn btn maz-gradient-btn">Add Images</button>
						</div>
					</div>
				</div>
				<!--end breadcrumb-->
							...
							<div class="card-body p-4">
								<div class="row g-3">
									<div class="col-md-6">
										...
										<input readonly type="text" class="form-control" id="input1" :value="singleTask?.name">
									</div>
									...
									<div class="col-md-6">
										...
										<input readonly type="text" class="form-control" id="input3" :value="singleTask?.status">
									</div>
									<div class="col-md-6">
										<label for="input4" class="form-label">Address</label>
										<input readonly type="email" class="form-control" id="input4" :value="singleTask?.address">
									</div>
									<div class="col-md-6">
										<label for="input5" class="form-label">Start Date</label>
										<input readonly type="text" class="form-control" id="input5" :value="singleTask?.startDate">
									</div>
									<div class="col-md-6">
										<label for="input6" class="form-label">End Date</label>
										<input readonly type="text" class="form-control" id="input6" :value="singleTask?.plannedEndtext">
									</div>

									<div class="col-md-6">
										<label for="input6" class="form-label">Time Record</label>
										<input readonly type="text" class="form-control" id="input6" :value="singleTask?.timeRecord">
									</div>
